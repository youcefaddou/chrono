...
export default function Footer () {
	...
	return (
		<footer className="footer-main w-full border-t border-neutral-200 mt-8 bg-white">
			<div className="max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row md:justify-evenly md:items-start gap-10">
				...
				<nav className="flex flex-col sm:flex-row gap-8 flex-1 justify-evenly">
					<ul className="footer-list flex flex-col gap-2 min-w-[120px]">
					...
					<ul className="footer-list flex flex-col gap-2 min-w-[160px]">
