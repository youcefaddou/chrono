			...
			{open && (
				<div className='mt-2'>
					{loading ? (
						...
						<div className='text-gray-500'>No recent login.</div>
					) : (
								...
								<tbody>
									{history.map(log => (
										<tr key={log._id} className='border-t'>
											<td className='px-4 py-2'>{log.date ? new Date(log.date).toLocaleString('en-GB') : '-'}</td>
